...
const Skills = () => {
  return (
    <div className="pt-3 pb-5" id="skills">
      <h1 className="text-center font-details-b pb-2">TECH SKILLS</h1>
      <CardDeck>
        <Row className="d-flex justify-content-around">
          ...
          <Col md={4}>
            <Card className="focus mt-2 mb-2">
              <Card.Body>
                <Card.Title className="text-center  card-title">Self-Learning</Card.Title>
                <hr />
                <Card.Text className="card-text d-flex justify-content-start flex-column">
